...
gcloud run deploy receipts-backend \
  ...
  --set-env-vars="GEMINI_API_KEY=$GEMINI_API_KEY,FEATHERLESS_API_KEY=$FEATHERLESS_API_KEY,GMAIL_CLIENT_ID=$GMAIL_CLIENT_ID,GMAIL_CLIENT_SECRET=$GMAIL_CLIENT_SECRET,SUPABASE_URL=$SUPABASE_URL,SUPABASE_SERVICE_ROLE_KEY=$SUPABASE_SERVICE_ROLE_KEY,SUPABASE_JWT_SECRET=$SUPABASE_JWT_SECRET,FRONTEND_URL=$FRONTEND_URL,GMAIL_REDIRECT_URI=$GMAIL_REDIRECT_URI"
